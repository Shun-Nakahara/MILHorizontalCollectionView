...
public class MILHorizontalCollectionViewController: UICollectionViewController {
...
// MARK: Public func
extension MILHorizontalCollectionViewController {
     ...
     */
    public func setUpWithInitialPlaceHolderItems(numberOfPlaceHolderCells : Int){
     ...
     */
    public func refresh(newDataArray : [String]){
     ...
     */
    public func setToHandleImageURLStrings(){
     ...
     */
    public func setToHandleImageURLStringsUsingSDWebImage(){
     ...
     */
    public func setToHandleLocalImageNameStrings(){
...
extension MILHorizontalCollectionViewController {
    ...
    override public func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier("horizontalcell", forIndexPath: indexPath) as!
        MILHorizontalCollectionViewCell
